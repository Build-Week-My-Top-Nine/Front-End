...
import AccessList from './categories/accessories/AccessoriesList'
import Food from './categories/food/FoodCard'
import FoodList from "./categories/food/FoodList";
        ...
        <div className="user-cat">
          <Form className="cat-select">
            <Field component="select" name="user-active-cat">
              ...
              <option value="accessories" onClick={<Link to="AccessoriesList" />}>
                Accessories
              </option>
