    ...
    <div className="App">
            <div className="user-topnine">
                <div className="user-cat">
                        ...
                        <NavLink className="usernav" to='/cars'>Cars</NavLink>
                        ...
                        <NavLink className="usernav" to='/videogames'>Video Games</NavLink>      
            </div>
            <UserSideDiv className="user-sidebar">
            <img className="userPic" src={img} alt="user img" />
            <h2 user={props.UserName}>{user || 'User Name'}</h2>
            </UserSideDiv>
            <UserCatBody>THIS IS WHERE USER SELECTED COMPONENTS SHOULD RENDER</UserCatBody>
            ...
            <div className="other-user-topnine">
                ...
                <OtherUserCatBody>THIS IS WHERE OTHER USER SELECTED COMPONENTS SHOULD RENDER</OtherUserCatBody>
            </div>
        </div>
