    ...
    <div className="App">
      ...
      <div className="App-body">
        ...
        <Route
          path="/accessories"
          render={props => (
            <Accessories {...props} handleChange={handleChange} />
          )}
        />
        <Route
          path="/animals"
          render={props => <Animal {...props} handleChange={handleChange} />}
        />
        <Route
          path="/boardgames"
          render={props => <BoardGame {...props} handleChange={handleChange} />}
        />
        <Route
          path="/books"
          render={props => <Book {...props} handleChange={handleChange} />}
        />
        <Route
          path="/cars"
          render={props => <Car {...props} handleChange={handleChange} />}
        />
        <Route
          path="/food"
          render={props => <Food {...props} handleChange={handleChange} />}
        />
        <Route
          path="/movies"
          render={props => <Movie {...props} handleChange={handleChange} />}
        />
        <Route
          path="/music"
          render={props => <Music {...props} handleChange={handleChange} />}
        />
        <Route
          path="/places"
          render={props => <Places {...props} handleChange={handleChange} />}
        />
        <Route
          path="/videogames"
          render={props => <VideoGame {...props} handleChange={handleChange} />}
        />
      </div>
    </div>
  );
